  ...
  server.addEventListener("message", async (event) => {
    try {
      ...
      if (message.type === "client_audio") {
        // Audio is base64 encoded from the frontend
